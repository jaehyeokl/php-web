...
<body>
    ...
    <!-- 게시글 작성 -->
    <form class="write-post" action="uproad_activity.php" method="post">
        <h1>추천 활동</h1>
        ...
        <!-- <span>썸네일 추가</span>
        <input class="" name="thumbnail" type="file" accept="image/*"> -->
